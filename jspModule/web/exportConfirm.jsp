<%@ page import="com.netcracker.students.o3.model.serialization.JsonEntitiesStorage" %>
...
<pre>
    <%=res%>
    <form action="${pageContext.request.contextPath}/exportConfirm.jsp" method="post">
